export default function Navbar() {
    return (
        <div className="flex items-center lg:justify-around justify-between border-b border-white/5 px-5 lg:px-20 h-16 bg-neutral-0">
            ...
            <div>
                <svg width="104" height="24" viewBox="0 0 104 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <path d="M96.2355 23.5H92.6842L95.1868 17.8513L90.1816 6.60156H93.7568L96.6734 13.6537C96.7753 13.9002 97.1246 13.8997 97.2259 13.653L100.12 6.60156H103.719L96.2355 23.5Z" fill="white"></path>
                    ...
                    <path d="M80.1204 4.64714C79.5643 4.64714 79.0797 4.44852 78.6666 4.05129C78.2534 3.63816 78.0469 3.14559 78.0469 2.57357C78.0469 2.00155 78.2534 1.51692 78.6666 1.11969C79.0797 0.706563 79.5643 0.5 80.1204 0.5C80.7084 0.5 81.2009 0.706563 81.5982 1.11969C82.0113 1.51692 82.2178 2.00155 82.2178 2.57357C82.2178 3.14559 82.0113 3.63816 81.5982 4.05129C81.2009 4.44852 80.7084 4.64714 80.1204 4.64714ZM78.4997 18.5186V6.60154H81.765V18.5186H78.4997Z" fill="white"></path>
                    <path d="M72.8125 18.5182V0.642578H76.0778V18.5182H72.8125Z" fill="white"></path>
                    <path d="M69.1256 18.6621C67.7909 18.6621 66.6945 18.2966 65.8365 17.5657C64.9943 16.8189 64.5733 15.7464 64.5733 14.3481V9.46211H62.166V6.60201H64.5733V3.28906H67.8385V6.60201H71.1992V9.46211H67.8385V13.7046C67.8385 14.4355 67.9974 14.9598 68.3152 15.2776C68.633 15.5795 69.1494 15.7305 69.8644 15.7305C70.3729 15.7305 70.8178 15.659 71.1992 15.516V18.3999C70.6271 18.5747 69.9359 18.6621 69.1256 18.6621Z" fill="white"></path>
            ...
            <div className="hidden lg:block">
                <ul className="flex items-center gap-5">
                    ...
                    <li className="font-medium px-3 py-2 rounded-md cursor-pointer hover:bg-white/8">Pricing</li>
                </ul>
            </div>

            <div className="hidden lg:flex gap-3">
                <button className="border border-white/20 px-3 py-1.5 rounded-md cursor-pointer hover:bg-white/5 duration-300">Sign In</button>
                <button className="bg-white text-black font-medium px-3 py-1.5 rounded-md cursor-pointer hover:bg-white/80 duration-300">Contact sales</button>
            </div>
        </div>
    )
}